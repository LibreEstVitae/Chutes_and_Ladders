...
public class ThreePlayerMode {
    ...
    public void startGame() {
        ...
        while (playerOnePosition < 100 && playerTwoPosition < 100 && playerThreePosition < 100) {
            printBoard(playerOnePosition, playerTwoPosition,playerThreePosition);
    ...
    public static void printBoard(int player1Position, int player2Position, int player3Positon) {
        System.out.println("*************************************************************");
        for (int i = 9; i >= 0; i--) {
